...
namespace VHMS_DL
{
    public class ReportDAL
    {
        ...
        public DataTable GetPatientDtlsByRegNo_VisitDateDAL(string UniqueInsId ,string RegNo, DateTime VisitDate, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public void UpdateRecordSeenByDoctorDAL(string RegNo, DateTime VisitDate, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable GetPatientDtlsByRegNo_or_VisitDateDAL(string UniqueInstId,string RegNo, DateTime VisitDate, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
