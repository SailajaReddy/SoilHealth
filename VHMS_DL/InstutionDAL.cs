...
namespace VHMS_DL
{
    public class InstutionDAL
    {
        ...
        /* INSERT PatientReg*/
        public DataTable InsertPaitentDAL(string Unique_InsId, DateTime Vdate, string Atype, string Breed ,string AgeInYear, string AgeInMonth, int Gender, string AnimalOwner, string StateCode,
            string Dcode, string Mcode, string Village, string mbno, string ExemptedCat, string Regfee, string UserName, string INSERT, string Purpose, string visittype,  string nos, string aadharno, string category,string divisioncd, string ConnKey)
        {
        ...
        public DataTable UpdatePaitentDAL(string RegNo, int Gender, string AgeInYear, string AgeInMonth, string RegFee, string AnimalOwner,string BreedCode, DateTime Vdate, string StateCode, string Dcode,
            string Mcode, string Village, string mbno, string UserName, string UPDATE, string Purpose, string visittype, string nos, string aadharno, string category, string divisioncd, string ConnKey)
        {
