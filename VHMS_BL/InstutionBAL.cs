...
namespace VHMS_BL
{
    public class InstutionBAL
    {
        ...
        /* INSERT PatientReg*/
        public DataTable getInsertPaitentBAL(string Unique_InsId, DateTime Vdate, string Atype, string Breed, string AgeInYear, string AgeInMonth, int Gender, string AnimalOwner, string StateCode, string Dcode, string Mcode,
            string Village, string mbno, string ExemptedCat, string Regfee, string UserName, string INSERT, string Purpose, string visittype, string nos, string aadharno, string category, string divisioncd, string ConnKey)
        {
            return objIns.InsertPaitentDAL(Unique_InsId, Vdate, Atype, Breed, AgeInYear, AgeInMonth, Gender, AnimalOwner, StateCode, Dcode, Mcode, Village, mbno, ExemptedCat, Regfee, UserName, INSERT, Purpose, visittype, nos, aadharno, category,divisioncd, ConnKey);
        }
        /* UPDATE PatientReg*/
        public DataTable UpdatePaitentBAL(string RegNo, int Gender, string AgeInYear, string AgeInMonth, string RegFee, string AnimalOwner, string BreedCode, DateTime Vdate, string StateCode, string Dcode, string Mcode, string Village, string mbno, string UserName, string UPDATE, string Purpose, string visittype, string nos, string aadharno, string category, string divisioncd, string ConnKey)
        {
            return objIns.UpdatePaitentDAL(RegNo, Gender, AgeInYear, AgeInMonth, RegFee, AnimalOwner, BreedCode, Vdate, StateCode, Dcode, Mcode, Village, mbno, UserName, UPDATE, Purpose, visittype, nos, aadharno, category, divisioncd, ConnKey);
        }
