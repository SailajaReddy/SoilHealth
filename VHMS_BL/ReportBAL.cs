...
namespace VHMS_BL
{
    public class ReportBAL
    {
        ...
        public DataTable GetPatientDtlsByRegNo_VisitDateBAL(string UniqueInsId, string RegNo, DateTime VisitDate, string ConnKey)
        {
            return objRptBL.GetPatientDtlsByRegNo_VisitDateDAL(UniqueInsId,RegNo, VisitDate, ConnKey);
        }
        public void UpdateRecordSeenByDoctorBAL(string RegNo, DateTime VisitDate, string ConnKey)
        {
            objRptBL.UpdateRecordSeenByDoctorDAL(RegNo,VisitDate, ConnKey);
        }
        public DataTable GetPatientDtlsByRegNo_or_VisitDateBAL(string UniqueInstId,string RegNo, DateTime VisitDate, string ConnKey)
        {
            return objRptBL.GetPatientDtlsByRegNo_or_VisitDateDAL(UniqueInstId,RegNo, VisitDate, ConnKey);
        }
