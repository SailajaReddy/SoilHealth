<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_FeeCollected_Rpt.aspx.cs"
    Inherits="DiagFeeCollected_Rpt" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Date Wise Fee Collected Report </span>
                </div>
                <div class="col-md-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:DropDownList ID="ddlDist" runat="server" CssClass="form-control" 
                                    AutoPostBack="True" onselectedindexchanged="ddlDist_OnSelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-3  text-right">
                                <label for="ddlInst">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <asp:Button ID="Button1" runat="server" Height="30px" OnClick="btnSubmit_Click" class="btn-success"
                                    Text="Submit" />
                            </div>
                        </div>
                        <div class="form-group">
