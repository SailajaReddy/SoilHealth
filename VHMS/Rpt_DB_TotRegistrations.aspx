<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_DB_TotRegistrations.aspx.cs"
    Inherits="Rpt_DB_TotRegistrations" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title"> No of Registrations </span>
                </div>
