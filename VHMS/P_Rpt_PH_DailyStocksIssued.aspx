<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_Rpt_PH_DailyStocksIssued.aspx.cs"
    Inherits="P_Rpt_PH_DailyStocksIssued" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Report on Daily Stocks Issued</span>
                </div>
                <div class="col-md-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:DropDownList ID="ddlInst" runat="server" CssClass="form-control" AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlInst_OnSelectedIndexChanged">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:DropDownList ID="ddlDrug" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                            ...
                            <div class="col-md-4 text-center">
                                <asp:RadioButtonList ID="rdRptType" CssClass="form-control" runat="server" RepeatDirection="Horizontal"
                                    OnSelectedIndexChanged="rdRptType_SelectedIndexChanged" AutoPostBack="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control" OnTextChanged="txtFromDtChanged"
                            ...
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtToDt" runat="server" CssClass="form-control" OnTextChanged="txtFromDtChanged"
                                    AutoPostBack="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 text-center">
                                <rsweb:ReportViewer ID="RptDailyStocksIssued" Width="100%" runat="server" SizeToReportContent="true"
