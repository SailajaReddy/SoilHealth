<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_PH_DailyStocksIssued.aspx.cs"
    Inherits="Rpt_PH_DailyStocksIssued" %>
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">                        
                            <div class="col-md-2  text-right">
                                <asp:Label ID="Label1" runat="server" Text="District :" CssClass="labelnew"></asp:Label>
                            </div>
                            <div class="col-md-2 text-center">
                            ...
                            <div class="col-md-2  text-right">
                                <asp:Label ID="Label3" runat="server" Text="Institution :" CssClass="labelnew"></asp:Label>
                            </div>
                            <div class="col-md-2 text-center">
                              <asp:DropDownList ID="ddlInst" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlInst_OnSelectedIndexChanged" CssClass="form-control"
                                                                            >
                                                                            <asp:ListItem>Select</asp:ListItem>
                                                                        </asp:DropDownList>
                            </div>
                            <div class="col-md-2  text-right">
                                <asp:Label ID="Label2" runat="server" Text="Drug :" CssClass="labelnew"></asp:Label>
                            </div>
                            <div class="col-md-2 text-center">
