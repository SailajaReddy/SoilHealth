<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_PatientHistory.aspx.cs"
    Inherits="Rpt_PatientHistory" %>
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <asp:GridView ID="GvPatientDtls" runat="server" AllowPaging="True" AutoGenerateColumns="False"                                        
                                        CellPadding="3" CellSpacing="2" CssClass="footable"
                                         PageSize="5" Width="100%" OnPageIndexChanging="GvPatientDtls_PageIndexChanging">
                                        <Columns>
