<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Dt_Ins_SchmWs_aadhar_DrugsIssued.aspx.cs"
    Inherits="Rpt_Dt_Ins_SchmWs_aadhar_DrugsIssued" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">District Wise Scheme Wise Drugs Issued </span>
                </div>
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            <div class="col-md-2  text-right">
                               <label><asp:Label ID="lblDist" runat="server" Text="Select District:" CssClass="labelnew"></asp:Label></label> 
                            </div>
                            <div class="col-md-2 text-center">
                                <asp:DropDownList ID="ddlDist" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlDist_OnSelectedIndexChanged" AutoPostBack="true">    
                            ...
                            <div class="col-md-2 text-center">
                                <asp:TextBox ID="txtFromDate" runat="server" MaxLength="50" CssClass="form-control"  OnTextChanged="ddlDist_OnSelectedIndexChanged" AutoPostBack="true"
                            ...
                            <div class="col-md-2 text-center">
                                <asp:TextBox ID="txtToDt" runat="server" MaxLength="12" CssClass="form-control" placeholder="Enter To Date." OnTextChanged="ddlDist_OnSelectedIndexChanged" AutoPostBack="true"
                                    required="required"></asp:TextBox>
                            </div>
                        </div>                       
                         <div class="form-group">
                            <div class="col-md-12  text-center">
                                <asp:RadioButton ID="rdWithAadhar" runat="server" GroupName="Aadhar" Text="Beneficiaries with Aadhar" Checked="true" OnCheckedChanged="ddlDist_OnSelectedIndexChanged" AutoPostBack="true"/>
                                <asp:RadioButton ID="rdWithoutAadhar" runat="server" GroupName="Aadhar" Text="Beneficiaries with out Aadhar"  OnCheckedChanged="ddlDist_OnSelectedIndexChanged" AutoPostBack="true"/>
                            </div>                            
                        </div>
                        <div class="form-group">
                            <div class="col-md-12 text-right">
                                ...
                                <asp:ImageButton ID="btnImgprint" Visible="false" runat="server" Width="4%" ToolTip="Print Report"
                                    ImageUrl="~/images/print-button.png" OnClick="btnImgprint_Click" /><asp:Label ID="lblParam"
                                        runat="server" Visible="false"></asp:Label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <asp:Button ID="btnSubmit" runat="server" Height="30px" Text="Submit" OnClick="btnSubmit_Click"
                                    class="btn-success" />
                            </div>
                        </div>
                        <div class="form-group">
