<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_PH_DailyStocksRcvd.aspx.cs"
    Inherits="Rpt_PH_DailyStocksRcvd" %>
                ...
                <div class="col-md-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">                        
                            ...
                            <div class="col-md-2  text-right">
                                <asp:Label ID="lblIns" runat="server" Text="Institution :" CssClass="labelnew"></asp:Label>
                            </div>
                            <div class="col-md-2 text-center">
                            ...
                            <div class="col-md-2  text-right">
                                <asp:Label ID="lblDrug" runat="server" Text="Drug :" CssClass="labelnew"></asp:Label>
                            </div>
                            <div class="col-md-2 text-center">
