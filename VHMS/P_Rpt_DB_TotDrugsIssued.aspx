<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_Rpt_DB_TotDrugsIssued.aspx.cs"
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title"><asp:Label ID="lblTitle" runat="server">Value of Drugs Issued</asp:Label></span>
                </div>
