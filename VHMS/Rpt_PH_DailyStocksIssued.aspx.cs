...
public partial class Rpt_PH_DailyStocksIssued : System.Web.UI.Page
{
    ...
    protected void getReport()
    {
        try
        {
            ...
            DataTable dt = ObjRptBL.Rpt_Ph_DailyStocksIssuedBAL(FromDt, ToDt, ddlDist.SelectedValue.ToString(), ddlInst.SelectedValue.ToString(), ddlDrug.SelectedValue.ToString(), ConnKey);
            if (dt.Rows.Count > 0)
            {
