<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_DiagFeeCollected_Rpt.aspx.cs"
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Date Wise Diagnostic Test Fee Collected Report</span>
                </div>
                <div class="col-md-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtToDt" runat="server" CssClass="form-control" 
                                   ></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
