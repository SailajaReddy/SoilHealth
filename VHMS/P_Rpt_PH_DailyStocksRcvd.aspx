<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_Rpt_PH_DailyStocksRcvd.aspx.cs"
    Inherits="P_Rpt_PH_DailyStocksRcvd" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Report on Daily Stocks Received</span>
                </div>
                <div class="col-md-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:DropDownList ID="ddlInst" runat="server" CssClass="form-control"  AutoPostBack="true" OnSelectedIndexChanged="ddlInst_OnSelectedIndexChanged">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                    ...
                                    <%--<asp:ListBox  ID="ddlDrug"  runat="server" SelectionMode="Multiple" AutoPostBack="true" OnSelectedIndexChanged="ddl_Drug_SelectedIndexChanged"   CssClass="form-control" >  </asp:ListBox>--%> 
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                    ...
                                    <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control" OnTextChanged="txtFromDtChanged" AutoPostBack="true"></asp:TextBox>
                            </div>
                            <div class="col-md-3  text-right">
                                <label for="txtToDt">
                                    To Date :</label>
                            ...
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtToDt" runat="server" CssClass="form-control" OnTextChanged="txtFromDtChanged" AutoPostBack="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <asp:Button ID="btnSubmit" runat="server" Height="30px" 
                                    OnClick="btnSubmit_Click" class="btn-primary"
                                    Text="Submit"  />
                            </div>
                        </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2"></div>
                            <div class="col-md-10 text-center">                               
                                <rsweb:ReportViewer ID="RptDailyStocksRcvd" Width="100%" runat="server" SizeToReportContent="true"
