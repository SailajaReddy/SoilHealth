<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_DA_PatientVisits.aspx.cs"
    Inherits="Rpt_DA_PatientVisits" %>
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                ...
                <div class="col-md-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">                        
                            <div class="col-md-3  text-right">
                                <asp:Label ID="Label1" runat="server" Text="Start Time :" CssClass="labelnew"></asp:Label>
                            </div>
                            <div class="col-md-3 text-center">
                            ...
                            <div class="col-md-3  text-right">
                                <asp:Label ID="Label2" runat="server" Text="End Time :" CssClass="labelnew"></asp:Label>
                            </div>
                            <div class="col-md-3 text-center">
                        ...
                        <div class="form-group">
                         <div class="col-md-1 text-center"></div>
                            <div class="col-md-10 text-center">
                                ...
                                <rsweb:ReportViewer ID="Report_DA_PatientVisits" Width="100%" runat="server" SizeToReportContent="true"
