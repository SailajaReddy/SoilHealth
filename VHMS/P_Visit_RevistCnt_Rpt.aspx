<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_Visit_RevistCnt_Rpt.aspx.cs"
    Inherits="P_Visit_RevistCnt_Rpt" %>
                ...
                <div class="zerogrid">
                    <div class="row">
                        ...
                        <div class="col-md-8 text-center" style="margin-top: 10px;" align="middle">
                            ...
                            <br>
                            <font size="5px" align="center" style="font-family: Times New Roman, Georgia, Serif;
                                text-shadow: 1.5px 1px white;"><b><asp:Label ID="lblstatename" runat="server" Text="Label"></asp:Label></b></font>
                        </div>
                        <div class="col-md-2 text-center">
                            <span>
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Report on Patient Registrations </span>
                ...
                <div class="col-md-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                               <asp:TextBox ID="txtFromDate" runat="server" OnTextChanged="txtFromDtChanged" AutoPostBack="true" CssClass="form-control style_txt_entry"></asp:TextBox>
                            </div>
                            <div class="col-md-3  text-right">
                               <label> <asp:Label ID="lbltodate" runat="server" Text="To Date:" CssClass="labelnew"></asp:Label></label>
                            </div>
                            <div class="col-md-3 text-center">
                                 <asp:TextBox ID="txtToDt" runat="server"  OnTextChanged="txtFromDtChanged" CssClass="form-control style_txt_entry" AutoPostBack="true"></asp:TextBox>
                            </div>
                        </div>
                       <%-- <div class="form-group">
                        ...
                        <label>  Select:</label>
                           ...
                           <div class="col-md-4 text-center">
                            <asp:RadioButtonList ID="rdRptType" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdRptType_SelectedIndexChanged" CssClass="form-control" AutoPostBack="true">
                                                                        <asp:ListItem Value="D" Selected="True">Daily Abstract</asp:ListItem>
                                                                        <asp:ListItem Value="M">Monthly Abstract</asp:ListItem>
                                                                        </asp:RadioButtonList>
                           </div>
                          </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <asp:Label ID="lblNoRecordFound" runat="server" Font-Bold="True" ForeColor="Red" Visible="False"></asp:Label>
                            </div>
                        </div>
                          <div class="form-group">
                            <div class="col-md-12 text-right">
                        ...
                        <div class="col-md-2"></div>
                            <div class="col-md-8 text-center">
                               <%-- <rsweb:ReportViewer ID="ReportViewer1" runat="server">
                                ...
                                <rsweb:ReportViewer ID="RptVistRevist" Width="100%" runat="server" SizeToReportContent="true"
