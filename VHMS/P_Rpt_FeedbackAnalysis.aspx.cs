...
public partial class P_Rpt_FeedbackAnalysis : System.Web.UI.Page
{
    ...
    */
    ...
    protected void getReport()
    {
        try
        {
            Rpt_FbAnalysis.LocalReport.DataSources.Clear();
            ...
            DataTable dt = objRptBL.FetchFeedbackAnalysisBAL(ddlInst.SelectedValue.ToString(),FromDt,ToDt, ConnKey);
            if (dt.Rows.Count > 0)
            {
                Rpt_FbAnalysis.LocalReport.DataSources.Add(new ReportDataSource("Ds_Rpt_FeedbackAnalysis", dt));
                // OR Set Report Path  
                Rpt_FbAnalysis.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("~/RDLCReports/Rpt_FeedbackAnalysis.rdlc");
                // Refresh and Display Report  
                Rpt_FbAnalysis.LocalReport.Refresh();
                //btnImgprint.Visible = true;
                Rpt_FbAnalysis.Visible = true;
    ...
    protected void btnImgprint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["ReportName"] = "FeedbackAnalysis";
