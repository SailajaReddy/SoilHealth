<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InstutionTypeMaster.aspx.cs"
   ...
   <%-- <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function Confirm(link) {
            ...
            if (confirm("Are you sure to delete the selected Institution Type?")) {
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title"> Institution Type Master</span></div>
                <div class="col-md-12">
                    <div class="col-md-1">
                    </div>
                    <div class="col-md-10  col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            <div class="col-md-3 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Institution Type Code: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                               
                                                        <asp:TextBox ID="txtInstutionCode" runat="server" CssClass="form-control validate[required]" MaxLength="2"
                                                            OnTextChanged="txtInstutionCode_TextChanged" placeholder="Institution Code"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtInstutionCode_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" FilterType="Numbers" TargetControlID="txtInstutionCode">
                        ...
                        <div class="form-group">
                            <div class="col-md-3 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Institution Type Name: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                                 <asp:TextBox ID="txtInstutionName" runat="server" CssClass="form-control validate[required]" placeholder="Institution Name"
                   ...
                   <div class="row">
                            ...
                            <div class="col-md-1"></div>
                             ...
                             <div class="col-md-10 text-center">
                                                   ...
                                                   <asp:GridView ID="GvInsType" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                               
                                                CssClass="footable"  OnPageIndexChanging="GvInsType_PageIndexChanging"
                                                OnRowCommand="GvInsType_RowCommand" OnRowEditing="GvInsType_RowEditing" PageSize="10" Width="85%">
                                                 <HeaderStyle CssClass="success" />
                                                     <Columns>
                                                    <asp:TemplateField HeaderText="Institution Type Code">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblInstTypeCode" runat="server" Text='<%# Bind("InstitutionTypeCode") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Institution Type Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblInstTypeName" runat="server" Text='<%# Bind("InstitutionTypeDesc") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
