<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrugMaster.aspx.cs" Inherits="Admin_DrugMaster" %>
   ...
   <%-- <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ChkValidChar() {
            ...
            var txtbx = document.getElementById("txtDrugCode").value;
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title"> Drug Master</span></div>
                <div class="col-md-12">
                    <div class="col-md-1">
                    </div>
                    <div class="col-md-10  col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            <div class="col-md-3 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Drug Code: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                               
                                        <asp:TextBox ID="txtDrugCode" runat="server" CssClass="form-control validate[required]" MaxLength="4"
                                                            placeholder="Drug Code" onkeypress="ChkValidChar();"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtDrugCode_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" TargetControlID="txtDrugCode" FilterType="Numbers">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                               <asp:TextBox ID="txtDrugName" runat="server" CssClass="form-control validate[required]" placeholder="Drug Name"
                                                            MaxLength="75"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtDrugName_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" TargetControlID="txtDrugName" FilterType="Custom,Numbers,UppercaseLetters,lowercaseLetters"
                                                            ValidChars=" .">
                                                        </ajax:FilteredTextBoxExtender>
                            </div>
                         ...
                         <div class="form-group">
                            <div class="col-md-3 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Units of Measurement: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                              <asp:DropDownList ID="ddl_Units" runat="server" CssClass="form-control">
                                                        </asp:DropDownList>
                                                      
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="g1" runat="server"
                                                            ControlToValidate="ddl_Units" ErrorMessage="Select Unit" InitialValue="Select"
                             ...
                             <div class="col-md-10 text-center">
                                                ...
                                                OnRowCommand="GridView1_RowCommand" OnRowEditing="GridView1_RowEditing" PageSize="10" Width="85%">
                                                 <HeaderStyle CssClass="success" />
                                                     <Columns>
                                                    <asp:TemplateField HeaderText="Drug Code">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbldcode" runat="server" Text='<%# Bind("DrugCode") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Drug Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbldnm" runat="server" Text='<%# Bind("DrugName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Units of Measurements">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblunit" runat="server" Text='<%# Bind("Unit") %>'></asp:Label>
                                                             <asp:Label ID="lblUnitCode" runat="server" Visible="false" Text='<%# Bind("UnitCode") %>'>
                                                            </asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
