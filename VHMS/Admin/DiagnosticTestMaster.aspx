<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DiagnosticTestMaster.aspx.cs" Inherits="Admin_DiagnosticTestMaster" %>
  ...
  <%--  <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ChkValidChar() {
            ...
            var txtbx = document.getElementById("txtDiagTestCode").value;
            if (txtbx.startsWith("0")) // true
            {
                document.getElementById("txtDiagTestCode").value = "";
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">   Diagnostic Test / Procedure Master</span></div>
                <div class="col-md-12">
                    <div class="col-md-1">
                    </div>
                    <div class="col-md-10  col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            <div class="col-md-4 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Diagnostic Test / Procedure Code: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                               
                                       <asp:TextBox ID="txtDiagTestCode" runat="server" CssClass="form-control validate[required]" MaxLength="4"
                                                            placeholder="Diagnostic Test / Procedure Code" onkeypress="ChkValidChar();"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtDiagTestCode_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" TargetControlID="txtDiagTestCode" FilterType="Numbers">
                        ...
                        <div class="form-group">
                            <div class="col-md-4 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Diagnostic Test / Procedure Name: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtDiagTestName" runat="server" CssClass="form-control validate[required]" placeholder="Diagnostic Test / Procedure Name"
                                                            MaxLength="75"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtDiagTestName_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" TargetControlID="txtDiagTestName" FilterType="Custom,Numbers,UppercaseLetters,lowercaseLetters"
                                                            ValidChars=" .">
                                                        </ajax:FilteredTextBoxExtender>
                            </div>
                   ...
                   <div class="row">
                            ...
                            <div class="col-md-1"></div>
                             ...
                             <div class="col-md-10 text-center">
                                                   ...
                                                   <asp:GridView ID="GvDiagTest" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                               
                                                CssClass="footable"  OnPageIndexChanging="GvDiagTest_PageIndexChanging"
                                                OnRowCommand="GvDiagTest_RowCommand" PageSize="10" Width="85%">
                                                 <HeaderStyle CssClass="success" />
                                                     <Columns>
                                                    <asp:TemplateField HeaderText="Diagnostic Test Code">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDiagTestCode" runat="server" Text='<%# Bind("DiagTestCode") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Diagnostic Test Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDiagTestName" runat="server" Text='<%# Bind("DiagTestName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Update/Delete" ShowHeader="False">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnEdit" runat="server" OnClick="lnkEdit_Click"
