<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnitMaster.aspx.cs" Inherits="DiseaseMaster" %>
 ...
 <%--   <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ChkValidChar() {
            ...
            var txtbx = document.getElementById("txtUnitCode").value;
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title"> Units Of Measurement Master</span></div>
                <div class="col-md-12">
                    <div class="col-md-1">
                    </div>
                    <div class="col-md-10  col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            <div class="col-md-3 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Unit Code: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                               
                                       <asp:TextBox ID="txtUnitCode" runat="server" CssClass="form-control validate[required]" MaxLength="2"
                                                            onkeypress="ChkValidChar();" placeholder="Unit Code"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtUnitCode_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" FilterType="Numbers" TargetControlID="txtUnitCode">
                        ...
                        <div class="form-group">
                            <div class="col-md-3 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Unit Name: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                               <asp:TextBox ID="txtUnitName" runat="server" MaxLength="75" CssClass="form-control validate[required]"
                                                            placeholder="Unit Name"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtUnitName_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" TargetControlID="txtUnitName" FilterType="UppercaseLetters, LowercaseLetters, Numbers, custom"
                                                            ValidChars=" .">
                                                        </ajax:FilteredTextBoxExtender>
                            </div>
                   ...
                   <div class="row">
                            ...
                            <div class="col-md-1"></div>
                             ...
                             <div class="col-md-10 text-center">
                                                ...
                                                CssClass="footable"  OnPageIndexChanging="GvUnits_PageIndexChanging" OnRowCommand="GvUnits_RowCommand" PageSize="10" Width="85%">
                                                 <HeaderStyle CssClass="success" />
                                                      <Columns>
                                                    <asp:TemplateField HeaderText="Unit Code">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblUCode" runat="server" Text='<%# Bind("UnitCode") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Unit Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblUName" runat="server" Text='<%# Bind("UnitName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
