<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegFeeMaster.aspx.cs" Inherits="Admin_RegFeeMaster" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Registration Fee Master</span></div>
                <div class="col-md-12">
                    <div class="col-md-1">
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                 <asp:DropDownList ID="ddlAnimal" runat="server" CssClass="form-control">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlAnimal"
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                 <asp:TextBox ID="txtregfee" runat="server" placeholder="Regfee" CssClass="form-control validate[required]"
                                                MaxLength="4"></asp:TextBox>
                                            <ajax:FilteredTextBoxExtender ID="txtregfee_FilteredTextBoxExtender" runat="server"
                                                Enabled="True" FilterType="Numbers" TargetControlID="txtregfee">
                                                 ...
                                                 <HeaderStyle CssClass="success" />
                                                  <Columns>
                                                    <asp:TemplateField HeaderText="Institution Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblInnm" runat="server" Text='<%# Bind("InstitutionName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Animal">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAnimal" runat="server" Text='<%# Bind("AnimalTypeDesc") %>'></asp:Label>
                                                            <asp:Label ID="lblAnimalTypeCode" runat="server" Visible="false" Text='<%# Bind("AnimalTypeCode") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Registration Fee">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblInsCode" runat="server" Text='<%# Bind("Unique_InstId") %>' Visible="false"></asp:Label>
                                                            <asp:Label ID="lblRegf" runat="server" Text='<%# Bind("RegFee") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
