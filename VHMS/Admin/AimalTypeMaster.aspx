<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AimalTypeMaster.aspx.cs"
    Inherits="EVHMS_UI_Admin_MandalMaster" %>
  ...
  <%--  <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function Confirm(link) {
            ...
            if (confirm("Are you sure to delete the selected Animal Type?")) {
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ChkValidChar() {
            ...
            var txtbx = document.getElementById("txtAnimalTCode").value;
            if (txtbx.startsWith("0")) // true
            {
                document.getElementById("txtAnimalTCode").value = "";
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Animal Type&nbsp; Master</span></div>
                <div class="col-md-12">
                    <div class="col-md-1">
                    </div>
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            <div class="col-md-3 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                     Animal Type Code: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtAnimalTCode" runat="server" CssClass="form-control validate[required]" MaxLength="2"
                                                            onkeypress="ChkValidChar();" placeholder="AnimalType Code"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtAnimalTCode_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" FilterType="Numbers" TargetControlID="txtAnimalTCode">
                        ...
                        <div class="form-group">
                            <div class="col-md-3 col-md-offset-2  text-right">
                                <label for="ddlfinyear">
                                    Animal Type Name: <span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                                 <asp:TextBox ID="txtAnimalName" runat="server" CssClass="form-control validate[required]" placeholder="AnimalType Name"
                                                            MaxLength="75"></asp:TextBox>
                                                        <ajax:FilteredTextBoxExtender ID="txtAnimalName_FilteredTextBoxExtender" runat="server"
                                                            Enabled="True" TargetControlID="txtAnimalName" FilterType="Custom,Numbers,UppercaseLetters,lowercaseLetters"
                                                            ValidChars=" .">
                                                        </ajax:FilteredTextBoxExtender>
                            </div>
                   ...
                   <div class="row">
                            ...
                            <div class="col-md-1"></div>
                             ...
                             <div class="col-md-10 text-center">
                                                   ...
                                                   <asp:GridView ID="GvAnimalType" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                               
                                                CssClass="footable" DataKeyNames="AnimalTypeCode" OnPageIndexChanging="GvAnimalType_PageIndexChanging"
                                                OnRowCommand="GvAnimalType_RowCommand" OnRowEditing="GvAnimalType_RowEditing" PageSize="10" Width="85%">
                                                 <HeaderStyle CssClass="success" />
                                                   <Columns>
                                                    <asp:TemplateField HeaderText="Animal Type Code">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblACode" runat="server" Text='<%# Bind("AnimalTypeCode") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Animal Type Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAName" runat="server" Text='<%# Bind("AnimalTypeDesc") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
