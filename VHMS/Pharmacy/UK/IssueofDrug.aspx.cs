    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Validate_Save())
            {
                ...
                objPhar.InsertIssueDrug_bySchemeBAL(ddt, Session["UniqueInstId"].ToString(), txtObservation.Text, lblDName.Text, lblRegistrationNo.Text, "I",Session["VisitId"].ToString(),ddlScheme.SelectedValue.ToString(), ConnKey);
