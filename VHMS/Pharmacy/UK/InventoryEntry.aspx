            ...
            <div class="main-header">
                <div class="zerogrid">
                    <div class="row">
                        ...
                        <div class="col-md-2 text-center">
                            <span>
                                <asp:Image ID="Image1" src="../../img/digital.png" Height="120px" runat="server"
                                    Width="120px" />
                            </span>
                        </div>
                        <div class="left-div">
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:DropDownList ID="ddl_Suply" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddl_Suply"
                                    ErrorMessage="Select Supplier" ForeColor="Red" InitialValue="0" ValidationGroup="g1"></asp:RequiredFieldValidator>
                            </div>
                            <div class="col-md-3  text-right">
                                <label for="ddlfinyear">
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <asp:DropDownList ID="ddl_Drug" runat="server" AutoPostBack="true" CssClass="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <label>
                                    <asp:Label ID="lblUntsMesmt" runat="server" Font-Bold="True"></asp:Label></label>
                            </div>
                            <div class="col-md-3  text-right">
                                <label for="txtdepartment">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtBatchNo" runat="server" CssClass="form-control validate[required]"
                                    MaxLength="20"></asp:TextBox>
                                <ajax:FilteredTextBoxExtender ID="txtBatchNo_FilteredTextBoxExtender" runat="server"
                                    Enabled="True" FilterType="Numbers" TargetControlID="txtBatchNo">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtqtyeachpack" runat="server" MaxLength="8" OnTextChanged="txtqtyeachpack_OnTextChanged"
                                ...
                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True"
                                    FilterType="Custom,Numbers" ValidChars="." TargetControlID="txtqtyeachpack">
                                </ajax:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtnoofpackages" runat="server" CssClass="form-control validate[required,custom[onlyNumberSp]]"
                                    MaxLength="8" AutoPostBack="True" OnTextChanged="txtnoofpackages_TextChanged"></asp:TextBox>
                                <ajax:FilteredTextBoxExtender ID="txtnoofpackages_FilteredTextBoxExtender" runat="server"
                                    Enabled="True" FilterType="Numbers,Custom" TargetControlID="txtnoofpackages"
                                    ValidChars=".">
                                </ajax:FilteredTextBoxExtender>
                            </div>
                            <div class="col-md-3  text-right">
                            ...
                            <div class="col-md-3 text-center">
                                <asp:TextBox ID="txtDquantity" runat="server" ReadOnly="true" CssClass="form-control validate[required,custom[onlyNumberSp]]"
                                    MaxLength="9"></asp:TextBox>
                                <ajax:FilteredTextBoxExtender ID="txtDquantity_FilteredTextBoxExtender" runat="server"
                                    Enabled="True" FilterType="Numbers,Custom" TargetControlID="txtDquantity" ValidChars=".">
                                </ajax:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <ajax:FilteredTextBoxExtender ID="txtValue_FilteredTextBoxExtender" runat="server"
                                    Enabled="True" FilterType="Numbers, Custom" TargetControlID="txtValue" ValidChars=".">
                                </ajax:FilteredTextBoxExtender>
                            </div>
                            <div class="col-md-3  text-right">
                                <label>
                                    Scheme :&nbsp;<span style="color: Red">*</span></label>
                            </div>
                            <div class="col-md-3 text-center">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <asp:GridView ID="GvInventory" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    CssClass="footable" OnPageIndexChanging="GvInventory_PageIndexChanging" OnRowEditing="GvInventory_RowEditing"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Value of Drugs(Rs.)">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblInscd" runat="server" Text='<%# Bind("Unique_InsId") %>' Visible="false"></asp:Label>
                                                <asp:Label ID="lblSuplCd" runat="server" Text='<%# Bind("SupplierCode") %>' Visible="false"></asp:Label>
                                                <asp:Label ID="lblDrugCd" runat="server" Text='<%# Bind("DrugCode") %>' Visible="false"></asp:Label>
