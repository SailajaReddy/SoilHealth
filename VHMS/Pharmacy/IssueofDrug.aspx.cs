    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Validate_Save())
            {
                ...
                objPhar.InsertIssueDrugBAL(ddt, Session["UniqueInstId"].ToString(), txtObservation.Text, lblDName.Text, lblRegistrationNo.Text, "I",Session["VisitId"].ToString(), ConnKey);
    ...
    protected void btn_add_Click(object sender, EventArgs e)
    {
        try
        {
            if (ValidateDrug())
            {
                ...
                ddt = objPhar.getdrugdetailsBAL(Session["UniqueInstId"].ToString(), ddl_Drug.SelectedValue.ToString(), ConnKey);
