<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_PatientDtlsByAnimalType.aspx.cs"
    Inherits="Institution_Report" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Patient Details Report </span>
                </div>
                    ...
                    <div class="col-md-10 col-md-10 col-sm-10 text-center">
                        ...
                        <div class="form-group">
                         <div class="col-md-2  text-right">
                           <label>     <asp:Label ID="Label1" runat="server" Text="Animal Type:" CssClass="labelnew"></asp:Label></label>
                            </div>
                            <div class="col-md-2 text-left">
                              <asp:DropDownList ID="ddl_AnimalType" runat="server"  CssClass="form-control"
                            ...
                            <div class="col-md-2 text-center">
                                <asp:TextBox ID="txtToDate" runat="server" MaxLength="12" CssClass="form-control" placeholder="Enter To Date."
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnSubmit" runat="server" Height="30px" Text="Submit" OnClick="btn_Submit_Click" class="btn-primary" />                                
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                        ...
                        <div class="form-group">
                         <div class="col-md-1 text-center"></div>
                            <div class="col-md-10 text-center">
                                ...
                                <rsweb:ReportViewer ID="Rpt_PatientStatistics" Width="100%" Height="100%" runat="server" SizeToReportContent="true"
                                                OnBack="Rpt_PatientStatistics_Back" OnDrillthrough="ReportViewer1_Drillthrough" ShowPrintButton="true">
                                            </rsweb:ReportViewer>
                            </div>
                            <div class="col-md-1 text-center"></div>
                        </div>
