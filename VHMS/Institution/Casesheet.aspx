<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Casesheet.aspx.cs" Inherits="Institution_Sheet" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10  col-sm-10" id="card" style="margin-top: 0">
                <div class="card-header">
                    <span class="card-title">Casesheet </span>
                </div>
                        ...
                        <div class="form-group">
                         <div class="col-md-1 text-center"></div>
                            <div class="col-md-10 text-center">
                                <asp:GridView ID="GvVisitDates" runat="server" AllowPaging="True" 
                                                            AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" 
                                                            BorderStyle="None" BorderWidth="1px"
                                                            OnPageIndexChanging="GvVisitDates_PageIndexChanging" OnRowCommand="GvVisitDates_RowCommand"
                                                            CssClass="Grid" PageSize="3" Width="374px">
                                                            <Columns>                                                           
                                                                <asp:TemplateField HeaderText="Visit Dates">
                                                                  <ItemTemplate>
                                                                     <asp:LinkButton ID="lblVisitDateDMY" CommandName="VisitDate" runat="server" ForeColor="Blue"
                                                                        Text='<%#Eval("VisitDate_DMY")%>'></asp:LinkButton>    
                                                                        <asp:Label ID="lblVisitDate" runat="server"  Visible="false" Text='<%#Eval("VisitDate")%>'></asp:Label>                                                                                         
                                                                </ItemTemplate>
                                                                </asp:TemplateField>
