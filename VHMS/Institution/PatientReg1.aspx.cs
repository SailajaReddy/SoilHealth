...
public partial class Patient : System.Web.UI.Page
{
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        if (Validate_Save())
        {
            ...
            if (rbtour.Checked == true)
            {
                //visttype = rbtour.Text;
                visttype = "Tour";
            }
            string purposelist = "";
            ...
            try
            {
                ...
                dt = ObjIns.getInsertPaitentBAL(UniqueInstId, Vdate, ddl_AnimalType.SelectedValue.ToString(), ddlBreed.SelectedValue.ToString(), txtAnimalAge.Text, ddl_AgeMonth.SelectedValue.ToString(), Genger,
                    ...
                    txtmbno.Text.Trim(), rdExempted.SelectedValue, lblRegFee.Text, UserName, "I", purposelist, visttype, txtnos.Text, aadharid, ddlcategory.SelectedValue,ddldivision.SelectedValue, ConnKey);
    ...
    public void FetchPatientDetails(string RegNo)
    {
        try
        {
            ...
            if (dtPatientDtls.Rows.Count > 0)
            {
                ...
                if (dtPatientDtls.Rows[0]["Place_of_Visit"].ToString() == "VH")
                {
                    rbvh.Checked = true;
                }
                if (dtPatientDtls.Rows[0]["Place_of_Visit"].ToString() == "Tour")
                {
                    rbtour.Checked = true;
                }
